...
export default function LearnSectionPage() {
  ...
  useEffect(() => {
    ...
    blocks.forEach((block) => {
      if (block.userAnswer) {
        const answer =
          typeof block.userAnswer === "string"
            ? block.userAnswer
                        ...
                        <div className="mb-6 space-y-3">
                          {block.options.map((option, optionIndex) => {
                            ...
                            if (isCompleted) {
                              if (isCorrectAnswer) {
                                optionColor =
                                  "border-green-300 bg-green-50 border-b-4";
                              } else if (isSelected) {
                                optionColor =
                                  "border-red-300 bg-red-50 border-b-4";
                              }
                            } else if (isSelected) {
                              // Selected but not completed - blue border
                              optionColor =
                                "border-blue-500 border-b-4 bg-white";
                            }
        ...
        <div className="fixed right-0 bottom-0 left-0 p-6">
          <div className="mx-auto max-w-lg rounded-lg border bg-[#FFDFE1] p-6">
            <div className="relative">
              <p className="mb-4 font-semibold text-[#EA2C2B]">
