...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-muted text-muted-foreground data-[state=active]:bg-green-500 data-[state=completed]:bg-green-500 data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium",
        className,
      )}
      data-state={state}
      {...props}
